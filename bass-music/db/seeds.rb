...
a1 = Album.create(cover: "http://imd.ulximg.com/image/src/cover/1406792981_effa067382ce109a71fc3b45a7c776fb.jpg/2d2cc83b8c6ab15e538c28ab86e70400/1406792981_m2186168_92.jpg", title: "My Beautiful Dark Twisted Fantasy", artist: "Kanye West")
...
a2 = Album.create(cover: "http://www.xxlmag.com/files/2013/12/beyonce-cover-500x500.jpg", title: "Beyonce", artist: "Beyonce")
...
a3 = Album.create(cover: "http://yaleherald.com/wp-content/uploads/2011/02/Adele-21-Album-Cover-Art-500x500.png", title: "21", artist: "Adele")
...
a4 = Album.create(cover: "http://www.hotnewhiphop.com/public/userfiles/channel-orange.jpg", title: "Channel Orange", artist: "Frank Ocean")
...
a5 = Album.create(cover: "https://consequenceofsound.files.wordpress.com/2012/10/kendrick-lamar-good-kid-cover.jpg", title: "Good Kid, M.A.A.D City", artist: "Kendrick Lamar")
...
a6 = Album.create(cover: "http://cdn2.thelineofbestfit.com/media/2013/04/4e6c6fb2-e1365861889277.jpg", title: "Random Access Memories", artist: "Daft Punk")
...
a7 = Album.create(cover: "http://ecx.images-amazon.com/images/I/51OJGJqDrQL.jpg", title: "The 20/20 Experience", artist: "Justin Timberlake")
